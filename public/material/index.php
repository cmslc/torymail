                                                                    ...
                                                                    <div class="d-flex align-items-center">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="fs-14 my-1"><a
                                                                                    href="apps-ecommerce-product-details.php"
                                            ...
                                            <div class="acitivity-timeline acitivity-main">
                                                <div class="acitivity-item d-flex">
                                                    <div class="flex-shrink-0 avatar-xs acitivity-avatar">
                                                        <div
                                                            class="avatar-title bg-success-subtle text-success rounded-circle shadow">
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    <div class="flex-shrink-0 avatar-xs acitivity-avatar">
                                                        <div
                                                            class="avatar-title bg-danger-subtle text-danger rounded-circle shadow">
                                                ...
                                                <div class="acitivity-item py-3 d-flex">
                                                    <div class="flex-shrink-0">
                                                        <div class="avatar-xs acitivity-avatar">
                                                            <div
                                                                class="avatar-title rounded-circle bg-info-subtle text-info shadow">
                                            ...
                                            <div class="mt-3">
                                                <div class="row align-items-center g-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="p-1">
                                                            <div
                                                                class="progress bg-success-subtle animated-progress progress-sm">
                                                ...
                                                <div class="row align-items-center g-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="p-1">
                                                            <div
                                                                class="progress bg-warning-subtle animated-progress progress-sm">
                                                ...
                                                <div class="row align-items-center g-2">
                                                    ...
                                                    <div class="col">
                                                        <div class="p-1">
                                                            <div
                                                                class="progress bg-danger-subtle animated-progress progress-sm">
