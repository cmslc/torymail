...
(function () {
	...
	function pluginData() {
		 ...
		 * flatpickr
		 */
		// Only initialize if flatpickr library is loaded
	...
	function initLeftMenuCollapse() {
		...
		if (document.documentElement.getAttribute("data-layout") == "vertical" || document.documentElement.getAttribute("data-layout") == "semibox") {
			var twoColMenu = document.getElementById("two-column-menu");
			if (twoColMenu) twoColMenu.innerHTML = "";
			if (document.querySelector(".navbar-menu")) {
				document.querySelector(".navbar-menu").innerHTML = navbarMenuHTML;
			}
			...
			if (scrollbarEl) {
				scrollbarEl.setAttribute("data-simplebar", "");
				scrollbarEl.classList.add("h-100");
			}
	...
	function updateHorizontalMenus() {
		...
		var scrollbarEl = document.getElementById("scrollbar");
		if (scrollbarEl) {
			scrollbarEl.removeAttribute("data-simplebar");
			scrollbarEl.classList.remove("h-100");
		}
		var navbarNav = document.getElementById("navbar-nav");
