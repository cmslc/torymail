...
<div class="admin-content">
    <div class="page-header">
        <h4><i class="ri-settings-3-line me-2"></i> Settings</h4>
    </div>
    ...
    <ul class="nav nav-tabs mb-0" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab-limits">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="tab-general">
            <div class="card-custom border-top-0" style="border-top-left-radius:0; border-top-right-radius:0;">
                <div class="card-body">
            ...
            <div class="card-custom border-top-0" style="border-top-left-radius:0; border-top-right-radius:0;">
                <div class="card-body">
                    <form id="formMail" class="settings-form" data-tab="mail">
                        ...
                        <hr class="my-4">
                        <h6 class="mb-3">MX Record Configuration</h6>
                        <div class="row g-3">
                            <div class="col-md-8">
