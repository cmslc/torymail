...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0"><?= __('edit_user'); ?>: <?= sanitize($user['fullname']); ?></h4>
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    <li class="breadcrumb-item"><a href="<?= admin_url('home'); ?>"><?= __('admin'); ?></a></li>
                    <li class="breadcrumb-item"><a href="<?= admin_url('users'); ?>"><?= __('users'); ?></a></li>
...
<div class="row">
    ...
    <div class="col-lg-4">
            ...
            <div class="card-body text-center">
                ...
                <div class="table-responsive mt-3">
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            <td class="text-muted"><?= __('registered'); ?></td>
                            <td class="text-end fw-semibold"><?= format_date($user['created_at']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted"><?= __('last_activity'); ?></td>
                            <td class="text-end fw-semibold"><?= $user['last_activity'] ? time_ago($user['last_activity']) : __('never'); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted"><?= __('storage'); ?></td>
                            <td class="text-end fw-semibold"><?= format_email_size($user['storage_used']); ?> / <?= format_email_size($user['storage_quota']); ?></td>
                        </tr>
                        <tr>
                            <td class="text-muted"><?= __('timezone_label'); ?></td>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="ri-user-settings-line me-1"></i> <?= __('user_details'); ?></h5>
            </div>
            <div class="card-body">
                <form id="editUserForm">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label"><?= __('max_mailboxes_per_domain'); ?></label>
                    ...
                    <div class="mb-3">
                        <label class="form-label"><?= __('new_password'); ?> <small class="text-muted"><?= __('password_keep'); ?></small></label>
                        <input type="password" name="new_password" class="form-control" minlength="6">
                    </div>
                    <div class="mt-3">
                        <button type="submit" class="btn btn-primary w-100" id="btnSaveUser">
                            <i class="ri-save-line me-1"></i> <?= __('save_changes'); ?>
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="col-lg-8">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="ri-global-line me-1"></i> <?= __('domains'); ?> (<?= count($userDomains); ?>)</h5>
            </div>
            <div class="card-body">
                    ...
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            <?php if (empty($userDomains)): ?>
                                <tr><td colspan="5" class="text-center text-muted py-3"><?= __('no_domains'); ?></td></tr>
                            <?php else: ?>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="ri-mail-settings-line me-1"></i> <?= __('mailboxes'); ?> (<?= count($userMailboxes); ?>)</h5>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover mb-0">
                        ...
                        <tbody>
                            <?php if (empty($userMailboxes)): ?>
                                <tr><td colspan="5" class="text-center text-muted py-3"><?= __('no_mailboxes'); ?></td></tr>
                            <?php else: ?>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0"><i class="ri-file-list-3-line me-1"></i> <?= __('recent_activity'); ?></h5>
            </div>
            <div class="card-body" style="max-height:400px; overflow-y:auto;">
                <?php if (empty($userLogs)): ?>
                    <div class="text-center text-muted py-4"><?= __('no_activity_short'); ?></div>
                <?php else: ?>
